...
legend('MAP EQ (BCJR)', '0_t_h Iteration', '1_s_t Iteration', '2_n_d Iteration', '4_t_h Iteration', 'BPSK, AWGN', 'SDVA, AWGN', 'Path Weighting Factor:', '\{0.577,0.577,0.577\}', 'MAP EQ + MAP Dec', 'f_d x t = 0.000222', 3);
