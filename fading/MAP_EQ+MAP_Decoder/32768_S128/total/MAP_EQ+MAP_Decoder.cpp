...
const int K = 16384;
const int N = 32768;
#define num_packet 700			// number of packets simulated
...
int main(void)
{
   ...
   double *LLR, *intrinsic, *extrinsic;
...
/************************************************************************/
   const float pi = 3.14159265358979;
	int i, j, l;
   double p_I, p_Q, *normal, **alpha, **beta, ***gamma, *delta, min, **a_priori;
...
void MAP_dec_BCJR(double *intrinsic, double *LLR, double *extrinsic,
