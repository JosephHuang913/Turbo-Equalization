...
/* Interleaver: S-random interleaver with S=64	      */
...
const int K = 4096;
const int N = 8192;
#define num_packet 3000			// number of packets simulated
...
struct ch_trel_diag ch_Trellis[8192][4][2];	// Trellis[time index][num_state][num_in_sym]
...
int main(void)
{
   ...
   cout << "Interleaver: S-random interleaver with S = 64" << endl;
   ...
   fprintf(records, "Interleaver: S-random interleaver with S = 64\n");
